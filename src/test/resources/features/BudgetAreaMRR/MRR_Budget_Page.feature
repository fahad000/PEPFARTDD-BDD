...
Scenario: Verify account type in Account dropdown list
		...
		Then I view the account dropdown following option should exist:   		  
   	  	...
   	  	|ESDF - OCO|FMF|FMF - OCO|GHP-STATE|GHP-USAID|IDA|IDA - OCO|IMET|IMET|
   	  	|INCLE|INCLE - OCO|MRA|MRA - OCO|NADR ATA|NADR ATA - OCO|NADR CTBT IMS|NADR CTBTO PrepComm|NADR CWD|
   	  	|NADR CWD - OCO|NADR EXBS|NADR CWD - OCO|NADR GTR|NADR EXBS - OCO|NADR IAEA|NADR NDF|NADR TIP|TI|
   	  	|NADR TIP - OCO|NADR WMDT|PKO|PKO - OCO|TI|TI - OCO|USAID Admin|USAID Admin - OCO|USAID Admin|
 #PBI-000
@version:Release1.0
@scenario:test-2 @demo
